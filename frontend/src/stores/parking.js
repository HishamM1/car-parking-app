...
export const useParking = defineStore('parking', () => {
    ...
    return { form, errors, loading, resetForm, startParking, getActiveParkings, stopParking, parkings, getStoppedParkings, stoppedParkings, getParking, parking: parkingDetails, resetParkingDetails }
